    ...
    for h in mh:
        for ia,a in enumerate(hamap[h]):
            for ir,r in enumerate(regions):
                ...
                globals()["foutUp"+ a + r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"tauScaleUp.root","RECREATE")
                print outDir+y+"/signalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"tauScaleUp.root"
                ...
                globals()["foutDown"+ a + r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"tauScaleDown.root","RECREATE")
                print outDir+y+"/signalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"tauScaleDown.root"

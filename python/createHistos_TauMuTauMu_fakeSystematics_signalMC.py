                ...
                for m in MuonIso:
                    for m2 in MuonIso:
                        ...
                        for event in globals()["treein" + h +a+r]:
                            globals()["hist" + h+a+r].Fill(event.invMassMu1Mu2_mm, event.eventWeight_mm*scale*lumi_map[y]*hXsecmap[h]*scaleUp)
                            globals()["2Dhist" + h+a+r].Fill(event.invMassMu1Mu2_mm, event.visMass4Mu_mm, event.eventWeight_mm*scale*lumi_map[y]*hXsecmap[h]*scaleUp)  
                            
                        print outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauMuTauMu"+"_"+y+"_"+m+"_"+m2+"_"+r+"_"+"fakeUp.root"
                        globals()["foutUp"+ h+a+r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauMuTauMu"+"_"+y+"_"+m+"_"+m2+"_"+r+"_"+"fakeUp.root","RECREATE")
                        ...
                        for event in globals()["treein" + h +a+r]:
                            globals()["hist" + h+a+r].Fill(event.invMassMu1Mu2_mm, event.eventWeight_mm*scale*lumi_map[y]*hXsecmap[h]*scaleDown)
                            globals()["2Dhist" + h+a+r].Fill(event.invMassMu1Mu2_mm, event.visMass4Mu_mm, event.eventWeight_mm*scale*lumi_map[y]*hXsecmap[h]*scaleDown)

                        print outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauMuTauMu"+"_"+y+"_"+m+"_"+m2+"_"+r+"_"+"fakeDown.root"
                        globals()["foutDown"+ h+a+r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauMuTauMu"+"_"+y+"_"+m+"_"+m2+"_"+r+"_"+"fakeDown.root","RECREATE")

...
fakeDir='/uscms_data/d3/zfwd666/MuMuTauTauAnalyzer/CMSSW_9_4_13/src/MuMuTauTauAnalyzer/2017/DeepTauID/bkgEffCheck/TauMuTauHad/RooDatasets/'
fileinDir = "/eos/uscms/store/user/zfwd666/2017/bkgEffCheck/TauMuTauHad/"
#TauMuTauHad_sideBand_vvlooseDeepVSjet.root
outputDir='/eos/uscms/store/user/rhabibul/HtoAA/HtoAA2017Deep/TauMuTauHad/RooDataSets/DataSystematics/'
...
for i,ifile in enumerate(tauDiscVSjet):
    ...
    for event in treein:
        finFakeEff = ROOT.TFile(fakeDir+"fakeTauEff_TauMuTauHad.root")
    ...
    foutcopy= ROOT.TFile(outputDir+"TauMuTauHad" + "_"+ "sideBand"+"_"+ifile + ".root", "RECREATE")
    dataColl.Write()
    foutcopy.Close()
    ...
    for event in treein:
        ...
        visFourbodyMass.setVal(event.visMassMuMuTauTau)
        dataColl.add(ROOT.RooArgSet(invMassMuMu, visDiTauMass, visFourbodyMass, fakeRateEfficiency))
    foutUp =  ROOT.TFile(outputDir+"TauMuTauHad" + "_"+ "signalRegion"+"_"+ifile +"_" + "fakeUp" + ".root", "RECREATE")
    dataColl.Write()
    foutUp.Close()
    
    foutUpcopy =  ROOT.TFile(outputDir+"TauMuTauHad" + "_"+ "sideBand"+"_"+ifile +"_" + "fakeUp" + ".root", "RECREATE")
    dataColl.Write()
    foutUpcopy.Close()
    ...
    for event in treein:
        ...
        visFourbodyMass.setVal(event.visMassMuMuTauTau)
        dataColl.add(ROOT.RooArgSet(invMassMuMu, visDiTauMass, visFourbodyMass, fakeRateEfficiency))
    foutDown =  ROOT.TFile(outputDir+"TauMuTauHad" + "_"+ "signalRegion"+"_"+ifile +"_" + "fakeDown" + ".root", "RECREATE")
    dataColl.Write()
    foutDown.Close()

    foutDowncopy =  ROOT.TFile(outputDir+"TauMuTauHad" + "_"+ "sideBand"+"_"+ifile +"_" + "fakeDown" + ".root", "RECREATE")
    dataColl.Write()
    foutDowncopy.Close()

...
for j,imuid in enumerate(muIdList):
    ...
    for k,ieleid in enumerate(eleIdList):
        ...
        for iy,y in enumerate(years):
            ...
            globals()["2Ddata3P1F1Hist" + str(j) + str(k)+str(iy)] = ROOT.TH2D()
            ...
            globals()["fout2" + str(j) + str(k)+str(iy) ] = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauMuTauMu_Order_Scale_" +y+"_"+muIdLabel[j]+"_"+muIdLabel[k]+"_"+ "signalRegionUnblind" +"_"+"nominal"+ ".root", "RECREATE")

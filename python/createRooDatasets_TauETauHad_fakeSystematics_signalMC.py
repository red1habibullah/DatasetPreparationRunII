        ...
        for ia,a in enumerate(hamap[h]):
            for ir,r in enumerate(regions):
                ...
                for event in globals()["treein" + a + r]:
                    ...
                    globals()["eventWeight" + a + r].setVal(event.eventWeight_et*scale*lumi_map[y]*hXsecmap[h]*scaleUp)
                    globals()["dataColl" + a + r].add(ROOT.RooArgSet(globals()["dimuMass" + a + r], globals()["visFourbodyMass" + a + r], globals()["eventWeight" + a + r]))

                globals()["foutUp"+ a + r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauETauHad"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"fakeUp.root","RECREATE")
                print outDir+y+"/signalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauETauHad"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"fakeUp.root"
                ...
                for event in globals()["treein" + a + r]:
                    globals()["dimuMass" + a + r].setVal(event.invMassMu1Mu2_et)
                    globals()["visFourbodyMass" + a + r].setVal(event.visMass2MuEleTau_et)
                    globals()["eventWeight" + a + r].setVal(event.eventWeight_et*scale*lumi_map[y]*hXsecmap[h]*scaleDown)
                    globals()["dataColl" + a + r].add(ROOT.RooArgSet(globals()["dimuMass" + a + r], globals()["visFourbodyMass" + a + r], globals()["eventWeight" + a + r]))

                globals()["foutDown"+ a + r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauETauHad"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"fakeDown.root","RECREATE")
                print outDir+y+"/signalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauETauHad"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"fakeDown.root"
                globals()["dataColl" + a + r].Write()

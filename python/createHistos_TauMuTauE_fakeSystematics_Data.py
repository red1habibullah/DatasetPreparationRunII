...
for j,imuid in enumerate(muIdList):
    ...
    for k,ieleid in enumerate(eleIdList):
        ...
        for iy,y in enumerate(years):
            ...
            globals()["foutUp1" + str(j) + str(k)+str(iy) ] = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauMuTauE_Rebin" +y+"_"+muIdLabel[j]+"_"+eleIdLabel[k]+"_"+ "sideBand" +"_"+"fakeUp"+ ".root", "RECREATE")
            globals()["foutUp2" + str(j) + str(k)+str(iy) ] = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauMuTauE_Rebin_" +y+"_"+muIdLabel[j]+"_"+eleIdLabel[k]+"_"+ "signalRegion" +"_"+"fakeUp"+ ".root", "RECREATE")
            
            
            globals()["foutDown1" + str(j) + str(k)+str(iy) ] = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauMuTauE_Rebin_" +y+"_"+muIdLabel[j]+"_"+eleIdLabel[k]+"_"+ "sideBand" +"_"+"fakeDown"+ ".root", "RECREATE")
            globals()["foutDown2" + str(j) + str(k)+str(iy) ] = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauMuTauE_Rebin_" +y+"_"+muIdLabel[j]+"_"+eleIdLabel[k]+"_"+ "signalRegion" +"_"+"fakeDown"+ ".root", "RECREATE")
                                                                         
            
            print "save a copy for re-use"
            globals()["data3P1F1HistOnlyTemp" + str(j) + str(k)+str(iy)]=ROOT.TH1D()
            globals()["data3P1F1HistTemp" + str(j) + str(k)+str(iy)]=ROOT.TH1D()
            globals()["2Ddata3P1F1HistTemp" + str(j) + str(k)+str(iy)]=ROOT.TH2D()
           
            
            print "cloning before scale-Up"
            ...
            print "trying to retrieve saved copy"

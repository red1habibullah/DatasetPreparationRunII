...
for j,imuid in enumerate(muIdList):
    ...
    for k,ieleid in enumerate(eleIdList):
        ...
        for iy,y in enumerate(years):
            ...
            globals()["data3P1F1File" + str(j) + str(k) +str(iy)] = ROOT.TFile(baseDir+y+"/Histogram/"+"All_"+y+"_signalRegion_nominal.root")
...
#                 globals()["2Ddata3P1F1HistOnly" + str(j) + str(k)+str(iy)].Fill(event.invMassMu1Mu2_me, event.visMass3MuEle_me,(fakeEff1+fakeEff2))
            ...
            #globals()["fout1" + str(j) + str(k)+str(iy) ] = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauMuTauE_Order_Scale_" +y+"_"+muIdLabel[j]+"_"+eleIdLabel[k]+"_"+ "sideBand" +"_"+"nominal"+ ".root", "RECREATE")
            globals()["fout2" + str(j) + str(k)+str(iy) ] = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauMuTauE_Rebin_" +y+"_"+muIdLabel[j]+"_"+eleIdLabel[k]+"_"+ "signalRegionUnblind" +"_"+"nominal"+ ".root", "RECREATE")

...
signalDir ="/eos/uscms/store/user/zfwd666/HAA/DeepTauID/TauHadTauHad/slimmedTausDeep/"

sidebandDir = "/eos/uscms/store/user/rhabibul/HtoAA/HtoAA2017Deep/TauHadTauHad/Trees/"

outputDir='/eos/uscms/store/user/rhabibul/HtoAA/HtoAA2017Deep/TauHadTauHad/RooDatasets/SignalMCSystematics/'
...
for j,index in enumerate(path):
    for i,ifile in enumerate(fileinDir):
        for iName in mlDisc:
            finName = index + ifile + "/HAA_MC_deepDiTauRaw_" + iName + ".root"
            ...
            globals()["fout" + ifile] = ROOT.TFile(outputDir+"TauHadTauHad_HaaMC_" + ifile + "_" + suffix[j] + "_" + iName + ".root", "RECREATE")
            ...
            globals()["foutUp" + ifile] = ROOT.TFile(outputDir+"TauHadTauHad_HaaMC_" + ifile + "_" + suffix[j] + "_" + iName + "_" + "fakeUp" +".root", "RECREATE")
            globals()["dataColl" + ifile].Write()
            ...
            globals()["foutDown" + ifile] = ROOT.TFile(outputDir+"TauHadTauHad_HaaMC_" + ifile + "_" + suffix[j] + "_" + iName +"_"+ "fakeDown" +".root", "RECREATE")
            globals()["dataColl" + ifile].Write()

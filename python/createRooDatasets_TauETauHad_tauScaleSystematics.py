...
baseDir='/uscms_data/d3/rhabibul/DatasetPrepRunII/CMSSW_10_2_18/src/DatasetPreparationRunII/data/ComninedTrees/TauETauHad/'
...
for i,index in enumerate(fileinDir):
    for j,jregion in enumerate(region):
        ...
        #finName = index + ifile + "/HAA_MC_" + iName + "Disc.root"
            ...
            globals()["fout" + str(index)+ str(jregion) + str(ktype)] = ROOT.TFile(outputDir+ "TauETauHad_HaaMC_" + index + "_" + jregion + "_" +"mediumDeepVsjet"+ "_" + ktype + ".root", "RECREATE")

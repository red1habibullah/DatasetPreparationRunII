...
for iy,y in enumerate(years):
    ...
    print "Start!"
    fout = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauHadTauHad_Partial" + "_"+y+"_MVAMedium_" +"signalRegion_nominal.root", "RECREATE")
    dataCollSignal.Write()
    fout.Close()
    print "done signal!"
    foutcopy = ROOT.TFile(outputDir+y+"/"+"DataDriven/"+"TauHadTauHad_Partial" + "_"+y+"_MVAMedium_" +"sideBand_nominal.root", "RECREATE")
    dataColl.Write()
    foutcopy.Close()
    print "done sideband!"

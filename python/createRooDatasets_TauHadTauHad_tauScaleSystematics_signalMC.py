...
outDir="/eos/cms/store/user/rhabibul/BoostedRooDatasets/TauHadTauHad_Partial/"
                ...
                for event in globals()["treein" + a + r]:
                    ...
                    if event.tauDisc_tt > 0.6:
                        ...
                        if event.tauPt_tt > 20 and event.tauPt_tt < 10000 and event.tauDisc_tt > 0.6:
                            ...
                            globals()["eventWeight" + a + r].setVal(event.eventWeight_tt*scale*lumi_map[y]*hXsecmap[h]*sfmaphigh[y]["nominal"])
                        globals()["dataColl" + a + r].add(ROOT.RooArgSet(globals()["dimuMass" + a + r], globals()["visFourbodyMass" + a + r], globals()["eventWeight" + a + r]))
                globals()["fout"+ a + r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad_Partial"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"nominal.root","RECREATE")
                print outDir+y+"/signalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad_Partial"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"nominal.root"
                ...
                for event in globals()["treein" + a + r]:
                    ...
                    if event.tauDisc_tt > 0.6:
                        ...
                        if event.tauPt_tt > 10 and event.tauPt_tt < 20 and event.tauDisc_tt > 0.6:
                            ...
                            globals()["eventWeight" + a + r].setVal(event.eventWeight_tt*scale*lumi_map[y]*hXsecmap[h]*sfmaplow[y]["scaleUp"])
                        if event.tauPt_tt > 20 and event.tauPt_tt < 10000 and event.tauDisc_tt > 0.6:
                            print "high sf scaleUp:",sfmaphigh[y]["scaleUp"] 
                            globals()["eventWeight" + a + r].setVal(event.eventWeight_tt*scale*lumi_map[y]*hXsecmap[h]*sfmaphigh[y]["scaleUp"])
                        globals()["dataCollUp" + a + r].add(ROOT.RooArgSet(globals()["dimuMass" + a + r], globals()["visFourbodyMass" + a + r], globals()["eventWeight" + a + r]))
                globals()["foutUp"+ a + r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad_Partial"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"tauScaleUp.root","RECREATE")
                print outDir+y+"/signalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad_Partial"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"tauScaleUp.root"
                ...
                for event in globals()["treein" + a + r]:
                    ...
                    if event.tauDisc_tt > 0.6:
                        ...
                        if event.tauPt_tt > 20 and event.tauPt_tt < 10000  and event.tauDisc_tt > 0.6:
                            ...
                            globals()["eventWeight" + a + r].setVal(event.eventWeight_tt*scale*lumi_map[y]*hXsecmap[h]*sfmaphigh[y]["scaleDown"])
                        globals()["dataCollDown" + a + r].add(ROOT.RooArgSet(globals()["dimuMass" + a + r], globals()["visFourbodyMass" + a + r], globals()["eventWeight" + a + r]))
                globals()["foutDown"+ a + r]=ROOT.TFile(outDir+y+"/SignalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad_Partial"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"tauScaleDown.root","RECREATE")
                print outDir+y+"/signalMC/"+"Haa_MC_"+h+"_"+a+"_"+"TauHadTauHad_Partial"+"_"+y+"_"+"MVAMedium"+"_"+r+"_"+"tauScaleDown.root"
